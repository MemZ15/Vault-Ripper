...
typedef struct _VCPU
{
    ...
    uint64_t MsrData[18];              // VMX-specific MSR data
    ...
    uint8_t* MsrBitmap;             // Virtual address of bitmap (allocated with MmAllocateContiguousMemory)
    PHYSICAL_ADDRESS MsrBitmapPA;   // Physical address used for VMCS MSR_BITMAP field
} VCPU, * PVCPU;
